<?php
    ...
    class DataBase{
        ...
        public function insertarProducto($nombre,$descripcion,$categoria,$precio){
            ...
            $sql = "insert into pedido (nombre, descripcion, categoria, precio) values (:nombre, :descripcion, :categoria, :precio)";
        ...
        public function buscarProducto($nombre){
            ...
            $conexion = $modelo -> get_conexion();
            $nombre = "%".$nombre."%";
            $sql = "select * from pedido where nombre like :nombre";
            $statement = $conexion -> prepare($sql);
            $statement -> bindParam(':nombre', $nombre);
            $statement -> execute();
            while($resultado = $statement -> fetch()){
        ...
        public function modificarProducto($campo, $valor, $id){
            $modelo = new Conexion();
            $conexion = $modelo->get_conexion();
            $sql = "update pedido set $campo = :valor where id = :id";
            $statement=$conexion->prepare($sql);
